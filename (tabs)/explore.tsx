  ...
  const handleAnalyzeText = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // Later: show a friendly error in the UI
        return;
      }
      ...
      // Make sure primaryCategory appears first in the list
      const suggestions = [
    ...
    >
      <ThemedView style={styles.container}>
        ...
        >
          ...
          {/* STEP4: RISK ASSESSMENT & RECOMMENDATIONS */}
